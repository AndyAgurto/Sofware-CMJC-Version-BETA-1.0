...
{
    /// <summary>
    /// Lógica de interacción para VerConsultas.xaml
    /// </summary>
    public partial class VerConsultas : Window
    {
        private VerConsultasVM viewModel;
        public VerConsultas(VerConsultasVM viewModel)
        {
            InitializeComponent();
        ...
        private void txtBusqueda_TextChanged(object sender, TextChangedEventArgs e)
        {
            ...
            viewModel.FiltrarConsultas(null);
