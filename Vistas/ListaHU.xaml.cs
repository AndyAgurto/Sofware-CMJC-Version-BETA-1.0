...
{
    /// <summary>
    /// Lógica de interacción para ListaHU.xaml
    /// </summary>
    public partial class ListaHU : Window
    {
        private ListaHUVM viewModel;
        public ListaHU(string userFullName)
        {
            InitializeComponent();
            UsuarioTxtBlock.Text = userFullName;
            viewModel = new ListaHUVM();
