...
namespace Sofware_CMJC_Version_1._0.Vistas
{
    ...
    {
        public EditarUsuario(EditarUsuarioVM viewModel)
        {
            InitializeComponent();
        ...
        {
            TextBlock placeholder = (TextBlock)FindName("ContraseñaPlaceHolderConfirm");
            ...
            if (DataContext is EditarUsuarioVM viewModel)
            {
                viewModel.ConfirmarContraseña = PasswordBox.Password;
            }
        }
        ...
        private void PasswordBox_PasswordChanged(object sender, RoutedEventArgs e)
        {
            ...
            if (DataContext is EditarUsuarioVM viewModel)
            {
                viewModel.NuevaContraseña = PasswordBox.Password;
            }
